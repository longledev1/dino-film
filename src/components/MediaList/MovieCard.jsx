...
const MovieCard = (props) => {
  const { title, date, point, poster, type, className, onDesktop } = props;
  return (
    <div className="rounded-md bg-gray-800 text-white">
      ...
      <div className={`mt-[-20px] ${className ? className : "p-1"}`}>
        <div className="group relative text-[14px]">
          <p
            className={`hover:text-button mt-4 truncate font-bold hover:cursor-pointer lg:mt-2 ${onDesktop ? "w-50" : ""}`}
          >
